...
namespace ComiqueriaLogic
{
    ...
    public sealed class Venta
    {
        ...
        private void Vender(int cantidad)
        {
            ...
            ruta = String.Format("{0}\\venta.xml", ruta);
            Serializador<Venta>.GuardarXML(ruta, this);

            ruta = String.Format("{0}", Environment.GetFolderPath(Environment.SpecialFolder.Desktop));
            ruta = String.Format("{0}\\venta.dat", ruta);
            Serializador<Venta>.GuardarBinario(ruta, this);
