...
namespace ComiqueriaApp
{
    public partial class PrincipalForm : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    ComiqueriaDAO bd = new ComiqueriaDAO();

                    bd.Eliminar(this.productoSeleccionado);
        ...
        private void InicializarFechaHora()
        {
            ...
            this.hilo = new Thread(ActualizarHora);
        ...
        public void ActualizarListaDAO(AccionesDB accion)
        {
            ComiqueriaDAO bd = new ComiqueriaDAO();

            this.comiqueria.Productos = bd.Leer();
        }
